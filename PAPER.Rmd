...
In the context of antibiotic perturbation however, widespread loss of protective bacteria allows the growth of bacteria which otherwise are outcompeted, including many *Proteobacteria* (*E. coli*).

Furthermore, the ability of *C. difficile* to colonize a community does not appear to be dependent soley on the loss of protective species.  Rather, it seems likely that as protective species are lost, advantageous bacteria such as *E. coli* can colonize quickly and adapt, which in turn also promotes a favorable environment for *C. dfficile* colonization. Many members of the proteobacteria---attributes: grow quickly, wide array of nutrient sources, more generalists. Examples of e.coli causing inflammation, which can help pathogens in some instances where bad for resident good bugs. Also e. coli using nutrients within mucus (?) or at least contributing to loss of oxygen near epithelium, which can also let pathogens get closer and colonize.. cause further damage (by toxins, etc)... 
