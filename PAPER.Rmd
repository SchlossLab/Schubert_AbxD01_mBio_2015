...
There is a clear need for more knowledge on *C. difficile* and its interactions between members of the bacterial community in understanding colonization resistance. Fecal microbiota transplants, which have been shown to increase *Bacteroidetes* and decrease *Proteobacteria* levels in the recipient, have successfully restored colonization resistance in patients and effectively resolved their severe CDI [Seekatz et al. 2014]. Precisely how this occurs is not fully understood, but it emphasizes the strength of the community as a whole in its protective ability. Individual probiotics have not worked with complete success [dendukuri 2005]. In fact, several studies using probiotic mixtures of several bacteria find these members often work better together than by themselves [lawley, pamer, stein, hickson 2007]. 



<not done>
Understanding the scope of relationships between bacteria in a community is necessary to learn about its response, in concert with its host, to perturbations including antibiotic-induced, pathogen invasion, probiotics doses, and diet changes, etc.

These observed changes in response to perturbation can be used to inform models and networks to predict future responses (stein, Gordon diet paper) and characterize bacterial interactions (psoriasis/Schubert, sparCC paper). 

</not done>


Although the applications for microbiome modelling are diverse, given the microbiome's relationship to many aspects of human health and disease, there are currently few studies attempt to model the microbiome to predict disease or estimate health [Pamer, psoriases, schubert]. Microbiome modeling has been successfully applied to the prediction of psoriasis diagnosis, in which a microbiota signature defining subjects with and without psoriasis was discovered [Statnikov et al 2013]. Similarly, incorporating microbiota data into epidemiological based models that classify *C. difficile* diagnosis significantly enhances predictive power [Schubert et al. 2013]. In a time-series model of microbiome dynamics, the microbiota response to *C. difficile* alone, clindamycin alone, or clindamycin followed by *C. difficile* challenge was predicted (spearman correlation of 0.62) [Stein et al. 2013]. 
...
![**Supplemental Figure 2.**](supplemental/sfigure2ab.png)
...
Correlation analysis identified major families with significant negative or positive relationships with *C. difficile*.  Many of the correlaions we observed were not surprising given other studies looking at the relationship between *C. difficile* and the microbiome. For instance, monocolonization of germfree mice with either a *Lachnospiraceae* species or *E. coli* were tested for their resistance to *C. difficile* colonization [Reeves]. Pre-colonization with *Lachnospiraceae* was able to decrease the levels of *C. difficile* observed, while *E. coli* had similar colonization levels compared to germfree mice given *C. difficile* alone. Association studies in humans with and without CDI in hospitals have also highlighted several bacteria found in this study, including *Lachnospiraceae*, *Rumicoccaceae*, *Clostridia*, and *Alistipes* as decreased and *E. coli* and *Streptococcus* as increased in subjects with CDI [Schubert, Antharam]. While we observe overlaps in bacteria with potentially protective roles in both mice and humans at broad taxonomy levels, there are notable differences at refined levels. *Porphyromonadaceae* (Class *Bacteroidales*), for example, are more common among mice than humans, where instead there are strong negative associations of *C. difficile* with *Bacteroides* (Class *Bacteroidales*) [Schubert]. 

Throughout our analysis, we observed examples of the significance of the microbiome as a whole over any individual bacterial species in contributing to resistance. No single bacteria was able to consistently explain the subsequent level of *C. difficile* observed. For example, the *Porphyromonadaceae* OTU3, along with the *Lachnospiraceae* OTU39, were the two most important OTUs in the model with strong negative correlations with *C. difficile*. The majority of microbiotas which had over 1% relative abundance of OTU3 had no detectable *C. difficile* (*Figure 5C*). However, a small group of microbiotas with greater than 1% OTU3 abundance, which included several streptomycin (0.1 mg/ml) treated, ampicillin treated (both 1 and 6 days recovery), and cefoperazone treated (both 0.1 mg/ml and 0.3 mg/ml) microbiotas, were not fully protected by the presence of this OTU alone and ranged in *C. difficile* levels from 10<sup>2</sup> to 10<sup>6</sup> CFU/g feces. Similarly, having low amounts of one "protective" bacteria such as *Lachnospriaceae* OTU39 does not automatically render the host susceptible to colonization. For instance streptomycin treated (0.1 mg/ml) mice did not harbor *Lachnospiraceae* OTU39, yet had undetectable levels of *C. difficile*. Thus the loss or absence of one protective bacterial species can be compensated by others, either related species or others with functional redundancy (as in redundancy in their protective abilities). 

< Clean >
Furthermore, the dynamics of *C. difficile* colonization does not appear to be dependent soley on the loss of protective species. Both *Escherichia* OTU11 and *Streptococcus* OTU78 were positively correlated with *C. difficile* colonization and important in the random forest model. Notably, *Escherichia* OTU11 was among the strongest positively correlated OTUs with *C. difficile* across all antibiotic treatments, except for streptomycin. In fact, while streptomycin treatment (5 mg/ml) lead to high *C. difficile* colonization, these communities had very little, if any, *Escherichia* OTU11. This demostrates that while *Escherichia* may aid in colonization of *C. difficile*, it is not essential. These observations lead to a model of colonization by *C. difficile* in which antibiotic perturbation leads to loss of protective species. This in turn eliminates competition, frees resources, and eliminates direct or indirect inhibitory effects of bacterial products (e.g. bacteriocins or short chain fatty acids) made by these protective bacteria. [can talk about change in gut with abx--loss of some, gain of others that are resistant to abx or grow up quickly after, and direct effects of abx... last weeks jclub paper; sonnenburg has 2 papers with nutrients/metbolites and cdiff related to the microbiome] 

< Clean >
While this may be suitable enough for *C. difficile* to colonize, other opportunistic species such as *Escherichia coli* and other *Proteobacteria* may also take advantage of these microbiota perturbations. Increased colonization by these bacteria can increase inflammation, produce a new profile of metabolites and bacterial products, reduce the mucus layer,  and deoxygenate the microoxic tiers nearing the epithelium. These changes in the gut milieu may be advantageous for *C. difficile* and other gut pathogens. Inflammation, for instance, has been shown to be advantageous for *Salmonella tyhpumurium* to further disrupt the indigenous microbiota []. Inflammation also leads to a shift in the availability of resources, such as nitrites, which can be used as an alternative resource by *Salmonella typhimurium* []. *E.coli* is capable of using resources found in the mucus layer while simultaneously deoxygenating this region []. This reduces the spatial protection of the mucus layer, allowing bacteria, including strictly anaerobic bacteria, and bacterial products (e.g. toxins) to more readily reach the epithelial layer.
...
< Transition >
Expanding on these studies, we have shown across several different types of perturbations that we can accurately predict the resistance levels of these communities to *C. 
This has great applications for predicting patient risk of CDI in the hospital. Furthermore, this analysis can be used towards the design of personalized medicine, whether through tailoring probiotic or antibiotic regimens. 
...
It’s also common for bacteria to change their behavior in the context of other bacterial species [Crost 2010, quorum sensing-biofilms, recognizing fellow bacterial species vs killing others, synergistic effects (sieuwerts 2010)]. 
