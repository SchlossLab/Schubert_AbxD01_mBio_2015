...
library(plotrix)
# Generate the 
stackedbarcharts(file="~/Documents/Github/abxD01/Figure 1/abxD01.final.tx.2.subsample.relabund.topdose2.forlogscale.csv", fileIDS = "~/Documents/Github/abxD01/Figure 1/topdose_tx2_barchart_ids.csv", graphLabels = abx, sortbyphyl = TRUE, graphbyphyl = FALSE)


stackedbarcharts(file="~/Documents/Github/abxD01/Figure 1/abxD01.final.tx.1.subsample.relabund.topdose2.forlogscale.csv", fileIDS = "~/Documents/Github/abxD01/Figure 1/topdose_tx1_barchart_ids.csv", graphLabels = abx, sortbyphyl = TRUE, graphbyphyl = FALSE)
...
text(1:nlevels(otuCorrs$family)+.1, par("usr")[3]-0.05, label=(family.labels), xpd=NA, pos=2, srt=45, cex=1)
...
leg<-legend("top", legend=phylum.labels, pch=c(6, 1, 0, 9, 2, 4), cex=0.7, bty="o", horiz=TRUE, pt.cex=1.5, text.width=2.5)
...
stackedbarcharts(file = "~/Documents/Github/abxD01/Figure 3/abxD01.final.tx2.subsample.alltitrations.forlogscale.csv", fileIDS = "~/Documents/Github/abxD01/Figure 3/alltitrations_tx2_barchart_ids.csv", excludeGroup="untr", divide = TRUE)
...
### Differences between recovery days' thetayc

### Statistical comparison of delayed and on time CFU results
```{r, eval=TRUE}
file<-read.csv("~/Documents/Github/abxD01/Figure 5/abxD01.final.tx2.subsample.alldelay.relabund.csv", header=T)
...
The file/fileIDS should be matched.
...
stackedbarcharts(file = "~/Documents/Github/abxD01/Figure 5/abxD01.final.tx.2.subsample.alldelay.forlogscale.csv", fileIDS = "~/Documents/Github/abxD01/Figure 5/alldelay_tx2_barchart_ids.csv", divide = TRUE)

```

## Modeling microbiota data can predict C. difficile colonization outcomes. 
