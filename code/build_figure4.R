...
# build_figure4.R
#
# This script builds Figure 4. The first thing it does is to calculate the
...
write.table(file="data/process/correlation_analysis.tsv", cbind(taxonomy=gsub("\\d", "", sig_taxonomy), sig_corrs), quote=F, row.names=T, sep="\t")
