...
n_full_features <- data[1,2]
rsq_full_features <- data[1,3] * 100

n_part_features <- data[2,2]
rsq_part_features <- data[2,3] * 100

binary_error <- data[3,3] * 100
```
