...
# Made graph showing number of OTUs included as function of avg abundance cutoff. 
# Based on this going to try using a 0.005 relabund cutoff or 0.5%, which leaves 81 OTUs included.
